...
// --- Email Verification ---
// MODIFIED to send JSON instead of redirecting
export const verifyEmail = async (req, res) => {
  ...
  try {
    ...
    if (rows.length === 0) {
      // User doesn't exist for this token
      return sendError(res, 404, "Verification failed: User not found.");
    }
    if (rows[0].verified) {
      // Already verified, this is a success case for the user
